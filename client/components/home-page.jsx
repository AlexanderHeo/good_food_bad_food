        ...
        <div className="openBox mt-3">
          <form onSubmit={this.handleSubmit}>
            <div className="d-flex flex-column mx-auto">
              ...
              <button className="fullButton mx-auto my-3" type="submit" name="entereffects" onClick={this.handleClick}>Rate A Meal</button>
              <button className="fullButton mx-auto my-3" type="submit" name="list" onClick={this.handleClick}>View Meal Ratings</button>
